...
print("Welcome to my chatbot".center(125))
pyttsx3.speak("Welcome to my chatbot")
...
print("github")
pyttsx3.speak("youtube")
print("youtube")
pyttsx3.speak("I can open Cloud Platforms like: AWS")
print("AWS")
pyttsx3.speak("I can open gmail")
print("Gmail")
pyttsx3.speak("I can open tenda")
print("Tenda")
pyttsx3.speak("I can open Window Media Player")
print("WMplayer")
